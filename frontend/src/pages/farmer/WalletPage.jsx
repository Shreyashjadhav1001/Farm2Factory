  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      <div className="flex flex-col md:flex-row gap-8">
        {/* Balance Card */}
        <div className="flex-1 bg-gradient-to-br from-neutral-900 to-neutral-800 rounded-[2rem] p-10 text-white shadow-2xl relative overflow-hidden group">
          ...
          <div className="mb-10 flex justify-between items-start relative z-10">
            <div>
              <p className="text-neutral-400 font-medium tracking-wide uppercase text-xs mb-1">Total Balance</p>
          ...
          <div className="flex gap-4 relative z-10">
             <button 
              ...
              className={`flex-1 py-4 px-6 rounded-2xl font-bold transition-all flex items-center justify-center gap-2 ${isDeposit ? 'bg-emerald-500 text-white shadow-lg shadow-emerald-500/30 ring-2 ring-emerald-400/20' : 'bg-white/5 hover:bg-white/10'}`}
             >
              <Plus size={20} />
              Add Money
             </button>
             <button 
              ...
              className={`flex-1 py-4 px-6 rounded-2xl font-bold transition-all flex items-center justify-center gap-2 ${!isDeposit ? 'bg-amber-500 text-white shadow-lg shadow-amber-500/30 ring-2 ring-amber-400/20' : 'bg-white/5 hover:bg-white/10'}`}
             >
        ...
        {/* Action Form */}
        <div className="w-full md:w-80 bg-white rounded-[2rem] p-8 border border-slate-100 shadow-xl shadow-slate-200/40">
          ...
          <form onSubmit={handleAction} className="space-y-6">
            <div className="space-y-2">
              ...
              <input 
                ...
                placeholder="0.00"
                className="w-full bg-slate-50 border-none px-5 py-4 rounded-xl text-lg font-bold outline-none ring-2 ring-transparent focus:ring-emerald-500/20 transition-all"
              />
            </div>
            {!isDeposit && (
      ...
      <div className="bg-white rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-200/40 overflow-hidden">
        <div className="px-10 py-8 border-b border-slate-100 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h3 className="text-2xl font-extrabold text-slate-800">Recent Transactions</h3>
          </div>
        </div>
